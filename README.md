<html>
    ...
    <body>
        ...
        <main>
            <h1 class="lo">Профессионалы советуют</h1>
            <section class="info">
                <article class="post">
                    <img  class="pic" src="https://learn.algoritmika.org/uploads/2021/03/tag-151102.svg"/>
        ...
        <footer>
            <div class="contacts">
                <p class="footer-text"><span class="tel">Адрес:</span> город Технологический,<br/> пр-д Современный, 29/2</p>
                <p class="footer-text home"><span class="tel">Телефон:</span> 4138-564</p>
            </div>
